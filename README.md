...
| Upgrade-trigger + tactiek (als-dan, variabelen) | Upgrade-pop-ups: 8 statpunten diep.io-stijl (levensregen, max levens, botsschade, kogelpantser, kogelschade, kogelsnelheid, herladen, snelheid — elk tot 7). Punten volgen het echte schema: elk level van 2 t/m 28, daarna om de drie levels tot 45 = **33 punten**, te weinig voor alles (8 × 7 = 56), dus kiezen is verplicht. Klassenboom: basis → lvl 15 → lvl 30 → lvl 45, met drie soorten munitie (kogels, drones, valstrikken) |
